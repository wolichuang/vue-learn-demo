<template id="headerNav">
        ...
        <div class="search-form" v-show="detailShow">
            <button type="button" @click="close" class="cl">关闭</button>

            <form action="/search" method="get">
                <div>
                    <input type="text" class="s-input" name="query" autofocus/>
                </div>
            </form>
            ...
            <ul>
                <li v-for="(item, index) in search">
                     <div>
                        <a v-for="i in search[index]" href="#">
                            <strong :style="{color:i.cl}">{{i.st}}</strong>
                            <span>{{i.sp}}</span>
                        </a>
                     </div>
                </li>
